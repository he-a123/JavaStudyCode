...
function_2();
    ...
    public static void function_2()throws  IOException{
        ...
        pro.setProperty("email","123@163.com");
        FileWriter fw = new FileWriter("d:\\pro.properties");
        //将集合中的键值对存入文件，使用集合的方法store传递字符输出流
        pro.store(fw,"123");
        fw.close();
    }//
    /**
    ...
    public static void function(){
        ...
        String value = pro.getProperty("d");
        System.out.println(value);

        //方法stringPropertyNames，将集合中存储的键存储到
        //Set集合，类似于Map接口的方法keySet
